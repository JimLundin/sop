...
from typing import Self, disjoint_base, final
...
class ParseError(SopError):
    ...
    @property
    def column(self) -> int: ...
    def __new__(cls, line: int, column: int, message: str) -> Self: ...
...
class ShapeError(SopError):
    ...
    @property
    def path(self) -> str: ...
    def __new__(cls, path: str, message: str) -> Self: ...
...
class Tagged[V = Value]:
    ...
    @property
    def value(self) -> V: ...
    def __new__(cls, tag: str, value: V) -> Self: ...
    def __hash__(self) -> int: ...
